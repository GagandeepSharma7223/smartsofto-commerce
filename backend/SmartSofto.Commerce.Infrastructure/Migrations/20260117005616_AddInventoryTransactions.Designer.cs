...
namespace SmartSofto.Commerce.Infrastructure.Migrations
{
    ...
    [Migration("20260117005616_AddInventoryTransactions")]
            ...
            modelBuilder.Entity("SmartSofto.Commerce.Domain.Models.InventoryTransaction", b =>
                {
                    ...
                    b.HasIndex("TenantId", "CreatedUtc").IsDescending(false, true);

                    b.HasIndex("TenantId", "ProductId", "CreatedUtc").IsDescending(false, false, true);
