        ...
        {!hasToken ? (
          <form onSubmit={onRequestLink} className="space-y-4">
            <div>
              ...
              <input
                type="email"
                className="w-full border border-[#E7E1D6] rounded-xl px-3 py-2 bg-white"
                value={email}
            ...
            <button
              ...
              className="bg-[#6FAF3D] hover:bg-[#5F9B34] text-white px-5 py-2.5 rounded-full w-full disabled:opacity-60"
            >
              {loading ? 'Sending...' : 'Send reset link'}
            </button>
            <div className="text-sm">
              Back to <Link href="/login" className="text-[#6FAF3D]">sign in</Link>
            </div>
          </form>
        ) : (
