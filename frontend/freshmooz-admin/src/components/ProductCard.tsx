...
export default function ProductCard({ product }: { product: Product }) {
  return (
    <div className="border border-[#E7E1D6] rounded-2xl overflow-hidden flex flex-col bg-white shadow-[0_10px_30px_rgba(217,19,138,0.06)] hover:shadow-[0_16px_36px_rgba(217,19,138,0.12)] transition">
      ...
      <div className="p-4 flex flex-col gap-2">
        ...
        <div className="mt-2 flex items-center justify-between">
          ...
          <div className="flex items-center gap-2">
            ...
            <Link href={`/product/${product.slug}`} className="text-[#6FAF3D] hover:underline text-sm">View</Link>
          </div>
        </div>
      </div>
    </div>
