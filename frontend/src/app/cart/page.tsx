        ...
        {merged.length === 0 ? (
          ...
          <div className="md:col-span-2 space-y-4">
            <div className="border rounded-md p-4 bg-white">
              ...
              {addrLoading ? (
                ...
                <div className="text-sm text-slate-700">
                  ...
                  <div>India</div>
                  <a href="/checkout" className="text-[#d9138a] underline text-xs">Change at checkout</a>
                </div>
              ) : (
                <div className="text-sm text-slate-600">
                  No saved address. <a href="/checkout" className="text-[#d9138a] underline">Add one at checkout</a>.
                </div>
              )}
            </div>
            {merged.map((i: any) => (
                ...
                >
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    <button
                      ...
                      title="Delete item"
                      className="inline-flex items-center justify-center h-9 w-9 rounded-full bg-[#d9138a] text-white hover:bg-[#c2107c] shadow"
            ...
            <div className="border rounded-md p-4 space-y-3 h-fit">
              ...
              <button className="border w-full py-2 rounded-md" onClick={priceWithApi}>
                Price with API
              </button>
              <a
                href="/checkout"
                className="bg-[#d9138a] hover:bg-[#c2107c] text-white w-full py-2 rounded-md text-center block"
              >
                Checkout
              </a>
            </div>
