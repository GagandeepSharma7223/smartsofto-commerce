  ...
  return (
    <div className="landing">
      ...
      <section className="hero" aria-label="Hero">
        ...
        <div className="copy">
          <h1>Fresh paneer, the way it should be.</h1>
          <p className="lead">Slow-cut, soft texture, clean finish — crafted from fresh milk and nothing extra.</p>
      ...
      <section id="value" className="value">
        <h2>Why families choose Standard Paneer</h2>
        ...
        <div className="value__grid">
          ...
          <div className="value__card"><span className="dot"></span><div><strong>Batch-wise QC</strong><br /><span className="muted">Every lot is tested for consistency.</span></div></div>
          ...
          <div className="value__card"><span className="dot"></span><div><strong>Clean label</strong><br /><span className="muted">Preservative-free &amp; vegetarian.</span></div></div>
        </div>
      </section>

      {/* PRODUCTS (teaser) */}
      <section id="products">
        <h2>Our Dairy Favourites</h2>
      ...
      <section id="story" className="story">
        <div className="story__inner">
          ...
          <p>Started in 1975, we’ve stayed committed to honest dairy—sourcing quality milk, maintaining hygienic standards, and crafting products that let ingredients shine.</p>
          <div className="chips" style={{justifyContent:'center',marginTop:14}}>
            <span className="chip" style={{borderColor:'#e1f1e9',color:'var(--leaf)'}}>Farm-sourced milk</span>
      ...
      <section aria-label="Quality">
        <div className="quality">
          ...
          <p style={{color:'#ddd'}}>Rapid chilling, modern processing, and sensory checks keep every bite consistent.</p>
        </div>
      </section>
      ...
      <section id="contact">
        ...
        <div style={{maxWidth:720,margin:'auto',textAlign:'center'}}>
          <form action="#" style={{display:'flex',gap:10,justifyContent:'center',flexWrap:'wrap',marginBottom:14}}>
            <input type="text" placeholder="Enter city or pincode" aria-label="City or pincode" style={{flex:1,minWidth:240,maxWidth:420,padding:'.9rem 1rem',border:'1px solid #e9ddea',borderRadius:14}} />
            <button className="btn primary" type="submit">Search</button>
          </form>
          <p>Email: <strong>hello@standardpaneer.com</strong></p>
          <p>WhatsApp: <strong>+91-XXXXXXXXXX</strong></p>
          <p>Instagram: <strong>@standardpaneer</strong></p>
        </div>
      </section>

      <footer>© {new Date().getFullYear()} Standard Paneer. All rights reserved.</footer>
    </div>
  )
}
