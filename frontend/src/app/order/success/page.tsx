    ...
    <div className="landing">
      <main className="max-w-3xl mx-auto px-4 py-12 space-y-6 text-center">
        ...
        <div className="flex items-center gap-3 justify-center">
          <Link href={`/order/${encodeURIComponent(orderId)}`} className="border px-4 py-2 rounded-md">View Order</Link>
          <Link href="/products" className="bg-[#d9138a] hover:bg-[#c2107c] text-white px-4 py-2 rounded-md">Continue Shopping</Link>
          <Link href="/" className="border px-4 py-2 rounded-md">Home</Link>
        </div>
      </main>
    </div>
  )
