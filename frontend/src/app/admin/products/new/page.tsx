    ...
    <div className="landing">
      <main className="max-w-3xl mx-auto px-4 py-10">
        <div className="flex items-center justify-between mb-6">
          ...
          <Link href="/admin/products" className="text-[#d9138a]">Back to Products</Link>
        </div>
        ...
        <form onSubmit={onSubmit} className="space-y-4">
          ...
          <button type="submit" disabled={loading || !form.name || !form.sku} className="bg-[#d9138a] hover:bg-[#c2107c] text-white px-4 py-2 rounded-md">
