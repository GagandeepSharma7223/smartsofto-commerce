      ...
      <main className="max-w-6xl mx-auto px-4 py-8">
        <div className="flex items-center justify-between mb-6">
          ...
          <Link
            ...
            className="bg-[#d9138a] hover:bg-[#c2107c] text-white px-4 py-2 rounded-md transition-colors focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-[#d9138a]"
          >
            Add New Product
          </Link>
        </div>
                        ...
                        <td className="px-3 py-2">
                          <div className="flex items-center gap-2">
                            <Link
                              ...
                              className="px-2 py-1 border border-slate-300 rounded text-slate-700 hover:text-[#d9138a] hover:border-[#d9138a] transition-colors focus:outline-none focus:ring-2 focus:ring-offset-1 focus:ring-[#d9138a]"
                            >
                              Edit
                            </Link>
                            <button
